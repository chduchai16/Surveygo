...
<head>
    ...
    <link rel="stylesheet" href="<?= htmlspecialchars($__publicBase, ENT_QUOTES, 'UTF-8') ?>/assets/css/footer.css">
    <link rel="stylesheet" href="<?= htmlspecialchars($__publicBase, ENT_QUOTES, 'UTF-8') ?>/assets/css/navbar.css">

    <link rel="stylesheet"
        href="<?= htmlspecialchars($__publicBase, ENT_QUOTES, 'UTF-8') ?>/assets/css/daily-rewards.css">
</head>

<body class="page page--daily-rewards">
    <?php
    if (defined('BASE_PATH')) {
        include BASE_PATH . '/app/Views/partials/_navbar.php';
    } else {
        echo '';
    }
    ?>
    ...
    <?php
    if (defined('BASE_PATH')) {
        include BASE_PATH . '/app/Views/partials/_footer.php';
    } else {
        echo '';
    }
    ?>
