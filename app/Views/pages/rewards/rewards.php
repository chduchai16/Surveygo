...
<head>
    ...
    <title><?= htmlspecialchars($appName . ' - Đổi Điểm', ENT_QUOTES, 'UTF-8') ?></title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
    <link rel="stylesheet" href="public/assets/css/app.css">
    <link rel="stylesheet" href="public/assets/css/footer.css">
    <link rel="stylesheet" href="public/assets/css/navbar.css">
    <link rel="stylesheet" href="public/assets/css/rewards.css">
</head>

<body class="page page--rewards">
    ...
    <section class="rewards-content">
        <div class="container py-5">
            ...
            <ul class="nav nav-pills rewards-tabs mb-4" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="card-tab" data-bs-toggle="tab" data-bs-target="#card-rewards"
                        type="button" role="tab">
                        <i class="fas fa-credit-card me-2"></i>Thẻ Quà Tặng
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="gift-tab" data-bs-toggle="tab" data-bs-target="#gift-rewards"
                        type="button" role="tab">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="reward-card reward-card--cash">
                                ...
                                <button class="btn btn-primary w-100 reward-btn" data-points="2300"
                                    data-amount="500000">
                                    <i class="fas fa-arrow-right me-2"></i>Đổi Ngay
                                </button>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="reward-card reward-card--cash">
                                ...
                                <button class="btn btn-primary w-100 reward-btn" data-points="4500"
                                    data-amount="1000000">
                                    <i class="fas fa-arrow-right me-2"></i>Đổi Ngay
                                </button>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Bạn muốn đổi <strong id="modal-points">0</strong> điểm để nhận <strong
